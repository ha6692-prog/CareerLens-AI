        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                ...
                <div
                    ...
                    onDrop={handleDrop}
                    className={`border-2 border-dashed rounded-2xl p-12 text-center mb-8 transition-all ${dragOver
                        ...
                        <div className="space-y-3">
                            {resumes.map((resume) => (
                                <div
                                    ...
                                    className="bg-white rounded-xl border border-gray-100 shadow-sm px-5 py-4 flex items-center justify-between cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
